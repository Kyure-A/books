    ...
    return (
        <>
            ...
            <div className="text-center">
                <p className="underline"><a href="https://github.com/Kyure-A/books">GitHub リポジトリ</a></p>
                <p className="underline"><a href="https://github.com/Kyure-A/books/blob/main/public/books.csv">CSV データ</a></p>
            </div>
        </>
    )
}
